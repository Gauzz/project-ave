...
if (isset($_GET["query"])) {
 ...
 $query=mysqli_query($conn,"SELECT * FROM  tbl_std_project WHERE email LIKE '%$GetSearch%' OR  name LIKE '%$GetSearch%' OR project_name LIKE '%$GetSearch%' OR subject LIKE '%$GetSearch%' OR language LIKE '%$GetSearch%'");
         ...
         <div class="content-wrapper">
            ...
            <section class="content-header">
               <div class="row">
                  <div class="col-md-6">
                     <h3 class="srb">
                        Search For <?= $GetSearch; ?> (<?= $countResults;?>)
                     </h3>
                  </div>
