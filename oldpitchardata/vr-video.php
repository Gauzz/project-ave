...
<link rel="stylesheet" href="//player.elevr.com/css/font-awesome.css">

<link rel="stylesheet" href="//player.elevr.com/css/elevr-player.css">

<script src="//player.elevr.com/lib/gl-matrix.js" type="text/javascript"></script>

<script src="//player.elevr.com/lib/util.js" type="text/javascript"></script>

<script src="//player.elevr.com/js/controls.js" type="text/javascript"></script>

<script src="//player.elevr.com/js/player-webgl.js" type="text/javascript"></script>

<script src="//player.elevr.com/js/webvr.js" type="text/javascript"></script>

<script src="//player.elevr.com/js/phonevr.js" type="text/javascript"></script>

<script src="//player.elevr.com/js/elevr-player.js" type="text/javascript"></script>
...
<body >
  ...
  <div id="video-container">
    ...
    <video class="hidden" preload="auto" id="video" loop="true" webkit-playsinline crossOrigin="anonymous">
      ...
      <source src="uploads/video/<?php echo $getVideo; ?>" type="video/mp4">
        ...
        <div id="video-controls" class="hidden">
          ...
          <select style="display: none;" id="video-select" class="rfloat">
