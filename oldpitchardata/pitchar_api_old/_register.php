...
include('../conn.php');
	...
	if ($getValidateCount==0){
        ...
        $query=mysqli_query($conn,"INSERT INTO tbl_users(verify,firstname,lastname,fullname,occupation,email,password,country,user_type)VALUES('0','$firstname','$lastname',' $fname','$occupation','$email','$password','$country','manual')");
