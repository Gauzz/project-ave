...
if (isset($_REQUEST["create"])) {
    ...
    $getEntr = $_REQUEST["subject"];
    $getBook = $_REQUEST["book"];
    $getMag = $_REQUEST["magaz"];
    $getEdu = $_REQUEST["education"];
    $calender = $_REQUEST["calender"];
    $getWeekStart = $_REQUEST["start_date"];
    $getWeekEnd = $_REQUEST["end_date"];
    ...
    if (isset($_FILES["modelobj"]["name"]) AND $_FILES["modelobj"]["size"] > 0) {
        ...
        $shortObFbx = substr($_FILES["modelobj"]["name"], -4);
    ...
    if (isset($_FILES["modelmtl"]["name"]) AND $_FILES["modelmtl"]["size"] > 0) {
        ...
        $mtlUrlPath = 'https://pitchar.io/uploads/obj/'.$mtlName;
    }
    else{
        $mtlName='';
    }
    ...
    if (isset($_FILES["images"])) {
        ...
        foreach ($_FILES["images"]["name"] as $key => $value) {
            $imageName=rand().'.jpg';
            $imageUrlPath = 'https://pitchar.io/uplaods/imgs/'.$imageName;
            $i++;
