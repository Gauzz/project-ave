...
(function ($) {
    ...
    // various templates
    var templates = {
        container: '<div class="multilevel-dropdown-container"><div class="multilevel-dropdown-display"><span class="multilevel-dropdown-value"></span> </div></div>',
    ...
    var MultilevelDropdown = function (element, options) {
        ...
        this.options = {
            ...
            labels: {
                ...
                close: '<i style="border:none;" class="fa fa-angle-left"></i>'
            }
        };
    ...
    MultilevelDropdown.prototype.setValue = function (value) {
        this.$items.each(function() {
            ...
            if($item.data('value') === value) {
                ...
                $item.parents('.' + config.classNames.children).addClass(config.classNames);
            } else  {
