...
$query=select("post_video","project_name='$pname'");
if (howMany($query)=='1') {
exit(json_encode(array('response' =>array("code" =>'2', "msg" => 'This Video Already Exists'))));
}
else{
$send=saveData("post_video",["type" => $_POST["type"],"project_name" => $_POST["projectname"],"tags" => $_POST["tags"],"description" => $_POST["description"],"content" => $getContent,"thumbnail" => $getThumb,"token" => token(15)]);
if ($send) {
$_SESSION["success"]="true";
exit(json_encode(array('response' => array("code" =>'1', "msg" => 'New Video Created Successfully!'))));
}
else{
exit(json_encode(array('response' =>array("code" =>'0', "msg" => 'Oops There is An Error In Adding Video!'))));
}
}
}
secureAdmin();
                ...
                <div class="page-content-wrapper">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <form id="formAddVideo" enctype="multipart/form-data">
                                <div class="card-body row">
                                    <div class="col-lg-4 p-t-20">
                                        <div class = "mdl-textfield mdl-js-textfield">
                                            <input autocomplete="off" required="" class = "mdl-textfield__input type" type = "text" id = "text1" name="type" value="video" readonly/>
