...
$query=select("post_audio","project_name='$pname'");
if (howMany($query)=='1') {
exit(json_encode(array('response' =>array("code" =>'2', "msg" => 'This Audio Already Exists'))));
}
else{
$send=saveData("post_audio",["type" => $_POST["type"],"project_name" => $_POST["projectname"],"tags" => $_POST["tags"],"description" => $_POST["description"],"content" => $getContent,"thumbnail" => $getThumb,"token" => token(15)]);
if ($send) {
$_SESSION["success"]="true";
exit(json_encode(array('response' => array("code" =>'1', "msg" => 'New Audio Created Successfully!'))));
}
else{
exit(json_encode(array('response' =>array("code" =>'0', "msg" => 'Oops There is An Error In Adding Audio!'))));
}
}
}
secureAdmin();
                ...
                <div class="page-content-wrapper">
                    <div class="page-content" style="min-height: 800px !important;">
                        <div class="page-bar">
                            <div class="page-title-breadcrumb">
                                <div class=" pull-left">
                                    <div class="page-title">Add Audio</div>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="card-box">
                                <div class="card-head">
                                <header>Add Audio</header>
                            </div>
                            <form id="formAddAudio" enctype="multipart/form-data">
                                <div class="card-body row">
                                    <div class="col-lg-4 p-t-20">
                                        <div class = "mdl-textfield mdl-js-textfield">
                                            <input autocomplete="off" required="" class = "mdl-textfield__input type" type = "text" id = "text1" name="type" value="audio" readonly/>
                                    ...
                                    <div class="col-lg-12 p-t-20">
                                        ...
                                        <input type="hidden" name="AddAudio" value="true">
                                    </div>
                                </div>
                            </form>
                        </div>
...
$('#formAddAudio').on('submit',(function(e) {
e.preventDefault();
