...
$token = $_POST['token'];
$query = select("product_feature", "token='$token'");
...
'response' => array(
"code" => '2',
"msg" => 'This product feature Not Exists'
)
)));
}
else{
$send = update("product_feature", ["name" => $_POST["category_name"], "description" => $_POST["descr"]],"token='$token'");
if ($send) {
$_SESSION["update"] = "true";
exit(json_encode(array(
'response' => array(
"code" => '1',
"msg" => 'Your product feature Updated Successfully!'
)
)));
}
else {
...
'response' => array(
"code" => '0',
"msg" => 'Opps There is An Error In Updating product feature!'
)
)));
}
}
...
$selectCategory = select("product_feature","token='$categoryToken'");
if (howMany($selectCategory) > 0) {
$getCategory = fetch($selectCategory);
}
else{
move("view-productfeature.php");
}
}
else{
move("view-productfeature.php");
                ...
                <div class="page-content-wrapper">
                    <div class="page-content" style="min-height: 800px !important;">
                        <div class="page-bar">
                            <div class="page-title-breadcrumb">
                                <div class=" pull-left">
                                    <div class="page-title">Edit Product Features</div>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="card-box">
                                <div class="card-head">
                                <header>Edit Product Feature</header>
                            </div>
                                ...
                                <div class="card-body row">
                                    <div class="col-lg-4 p-t-20">
                                        <div class = "mdl-textfield mdl-js-textfield">
                                            ...
                                            <label class = "mdl-textfield__label lblname" for = "text1">Product Feature Name</label>
                                        </div>
                                    </div>
...
window.location.href='view-productfeature.php';
}
