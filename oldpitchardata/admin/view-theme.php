...
if (isset($_POST["data"])) {
$token=$_POST["data"];
$query=deleteRow("product_theme","token='$token'");
if ($query) {
                    ...
                    <div class="page-content">
                        <div class="page-bar">
                            <div class="page-title-breadcrumb">
                                <div class=" pull-left">
                                    <div class="page-title">View Theme</div>
                                </div>
                                <ol class="breadcrumb page-breadcrumb pull-right">
                                    <li><i class="fa fa-home"></i>&nbsp;<a class="parent-item" href="index.php">Home</a>&nbsp;<i class="fa fa-angle-right"></i>
                                </li>
                                <li class="active">View Theme</li>
                            </ol>
                        </div>
                    </div>
                    <div class="row">
                                ...
                                <div class="table-wrap">
                                    <div class="table-responsive">
                                        <table class="table display product-overview mb-30" id="support_table5">
                                            ...
                                            <tbody>
                                                <?php $query=select("product_theme");
                                                $i=1;
                                                while($getCategory=fetch($query)){
                                                $date=date_create($getCategory["create_at"]);
                                                ?>
                                                <tr class="<?= 'cls'.$getCategory["id"]; ?>">
                                                    ...
                                                    <td>
                                                        <a href="edit-theme.php?token=<?php echo $getCategory["token"];?>" class="btn btn-tbl-edit btn-xs editcategory">
