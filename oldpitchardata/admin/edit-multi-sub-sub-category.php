...
$token = $_POST['token'];
$query = select("multi_sub_sub_category", "token='$token'");
...
if (move_uploaded_file($tmp, "uploads/MultisubSubCategoryImages/".$imageName)) {
...
$send = update("multi_sub_sub_category", ["name" => $_POST["name"], "description" => $_POST["description"], "images" => $imageName],"token='$token'");
if ($send) {
...
$selectCategory = select("multi_sub_sub_category","token='$categoryToken'");
if (howMany($selectCategory) > 0) {

$getCategorySelect = fetch($selectCategory);
}
else{
move("view-multi-sub-sub-category.php");
}
}
else{
move("view-multi-sub-sub-category.php");
                ...
                <div class="page-content-wrapper">
                    <div class="page-content" style="min-height: 800px !important;">
                        <div class="page-bar">
                            <div class="page-title-breadcrumb">
                                <div class=" pull-left">
                                    <div class="page-title">Edit Product Category</div>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="card-box">
                                <div class="card-head">
                                <header>Edit Product Category</header>
                            </div>
                                ...
                                <div class="card-body row">
                                    <div class="col-lg-4 p-t-20">
                                        <div class = "mdl-textfield mdl-js-textfield">
                                            ...
                                            <label class = "mdl-textfield__label lblname" for = "text1">Product Category Name</label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-12 p-t-20">
                                        <div class="row">
                                            <div class="col-lg-6 p-t-20">
                                                ...
                                                <img src="<?php echo (!empty($getCategorySelect["images"])) ? 'uploads/MultisubSubCategoryImages/'.$getCategorySelect["images"] : 'uploads/MultisubSubCategoryImages/no-thumbnail.png' ?>" id="category_image" height="250px" width="250px">
                                                <br><br>
...
$.ajax({
type:'POST',
url: 'edit-multi-sub-sub-category.php?token='+token,
data:formData,
cache:false,
dataType:'json',
contentType: false,
