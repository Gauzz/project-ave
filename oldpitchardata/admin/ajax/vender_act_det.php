<?php
 include '../conn.php';
	...
	$id=$_REQUEST['a']; 
 	...
 	$sql="SELECT * FROM add_vendor WHERE id='$id'"; 
...

	{
		...
		$update="UPDATE add_vendor SET status='Active' WHERE id='$id'";
...

	{
		...
		$update="UPDATE add_vendor SET status='Deactive' WHERE id='$id'";
...
<?php
	...
	$select="SELECT * FROM add_vendor WHERE id='$id' ";
