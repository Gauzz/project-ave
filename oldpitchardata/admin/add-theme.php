...
if (isset($_POST["send"])) {
$cname=$_POST['themeName'];
$query=select("product_theme","name='$cname'");
if (howMany($query)=='1') {
exit(json_encode(array('response' =>array("code" =>'2', "msg" => 'This Theme Name Already Exists'))));
}
else{
$send=saveData("product_theme",["name" => $_POST["themeName"],"description" => $_POST["categoryDescrip"],"token" => token(12)]);
if ($send) {
                    ...
                    <div class="page-content" style="min-height: 800px !important;">
                        <div class="page-bar">
                            <div class="page-title-breadcrumb">
                                <div class=" pull-left">
                                    <div class="page-title">Add Theme</div>
                                </div>
                                ...
                                <div class="card-body row">
                                    <div class="col-lg-4 p-t-20">
                                        <div class = "mdl-textfield mdl-js-textfield">
                                            <input autocomplete="off" required="" class = "mdl-textfield__input cname" type = "text" id = "text1" name="themeName" >
                                            <!--  pattern="[A-Z a-z]+" -->
                                            <label class = "mdl-textfield__label lblname" for = "text1">Theme Name</label>
...
window.location.href='add-theme.php';
}
