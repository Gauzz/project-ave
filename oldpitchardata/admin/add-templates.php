...
if (isset($_POST["AddTemplates"])) {
$pname=$_POST['projectname'];
/*$id=$_POST['getCategoryId'];*/
$valid_formatss = array("html");
...
move_uploaded_file($tmps,"templates/".$contName);
$getContent = 'https://pitchar.io/admin/templates/'.$contName;
/*}*/
}
}else{
...
$query=select("post_templates","project_name='$pname'");
if (howMany($query)=='1') {
exit(json_encode(array('response' =>array("code" =>'2', "msg" => 'This Template Already Exists'))));
}
else{
$send=saveData("post_templates",["type" => $_POST["type"],"project_name" => $_POST["projectname"],"tags" => $_POST["tags"],"description" => $_POST["description"],"content" => $getContent,"thumbnail" => $getThumb,"token" => token(15)]);
if ($send) {
$_SESSION["success"]="true";
exit(json_encode(array('response' => array("code" =>'1', "msg" => 'New Template Created Successfully!'))));
}
else{
exit(json_encode(array('response' =>array("code" =>'0', "msg" => 'Oops There is An Error In Adding Template!'))));
}
}
}
secureAdmin();
                ...
                <div class="page-content-wrapper">
                    <div class="page-content" style="min-height: 800px !important;">
                        <div class="page-bar">
                            <div class="page-title-breadcrumb">
                                <div class=" pull-left">
                                    <div class="page-title">Add Templates</div>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="card-box">
                                <div class="card-head">
                                <header>Add Templates</header>
                            </div>
                            <form id="formAddTempl" enctype="multipart/form-data">
                                <div class="card-body row">
                                    <div class="col-lg-4 p-t-20">
                                        <div class = "mdl-textfield mdl-js-textfield">
                                            <input autocomplete="off" required="" class = "mdl-textfield__input type" type = "text" id = "text1" name="type" value="templates" readonly/>
                                    ...
                                    <div class="col-lg-12 p-t-20">
                                        ...
                                        <input type="hidden" name="AddTemplates" value="true">
                                    </div>
                                </div>
                            </form>
                        </div>
...
$('#formAddTempl').on('submit',(function(e) {
e.preventDefault();
var formData = new FormData(this);
$.ajax({
type:'POST',
url: 'add-templates.php',
data:formData,
cache:false,
dataType:'json',
contentType: false,
