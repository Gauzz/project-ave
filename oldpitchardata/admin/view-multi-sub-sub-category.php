...
if (isset($_POST["data"])) {
$token=$_POST["data"];
$query=deleteRow("multi_sub_sub_category","token='$token'");
if ($query) {
...
$getQuery=mysqli_query($conn,"SELECT * FROM multi_sub_sub_category WHERE id='$id'");
...
$statusChange=mysqli_query($conn,"UPDATE multi_sub_sub_category SET status='$status' WHERE id='$id'");
if ($statusChange){
                    ...
                    <div class="page-content">
                        <div class="page-bar">
                            <div class="page-title-breadcrumb">
                                <div class=" pull-left">
                                    <div class="page-title">View Product Category</div>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="card  card-box">
                                <div class="card-head">
                                <header>View Product Category</header>
                            </div>
                            <div class="card-body ">
                                <div class="table-wrap">
                                    <div class="table-responsive">
                                        <table id="example1" class="table display product-overview mb-30" style="width: 0px;">
                                            <thead>
                                                <tr>
                                                    <th>No</th>
                                                    <th>Image</th>
                                            ...
                                            <tbody>
                                                <?php $query=select("multi_sub_sub_category");
                                                $i=1;
                                                ...
                                                <tr class="<?= 'cls'.$getCategory["id"]; ?>">
                                                    <td><?= $i++ ?></td>
                                                    <td>
                                                        <img src="<?php echo (!empty($getCategory["images"])) ? 'uploads/MultisubSubCategoryImages/'.$getCategory["images"]: 'https://www.korsbakken.no/content/images/thumbs/default-image_450.png' ;?>" style="border-radius: 50%;width: 100px;height: 100px;">
                                                    </td>
                                                    <td><?php
                                                    ...
                                                    <td>
                                                        <?php
                                                        $multisubcatId=$getCategory['multi_sub_cat_id'];
                                                        $queryGetmultisubCategory=select("multi_sub_category","id='$multisubcatId'");
                                                        $fetchmultisubCategory=fetch($queryGetmultisubCategory);
                                                        echo $fetchmultisubCategory["name"];
                                                        ?>
                                                    </td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="edit-multi-sub-sub-category.php?token=<?php echo $getCategory["token"];?>" class="btn btn-tbl-edit btn-xs editcategory">
...
swal({
title: "Are you sure?",
text: "want to delete this Product Category!",
icon: "warning",
buttons: true,
dangerMode: true,
})
...
if (willDelete) {
$.ajax({
url: 'view-multi-sub-sub-category.php',
type: 'POST',
dataType: 'json',
data: {data:token},
})
