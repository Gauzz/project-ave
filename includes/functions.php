...
define('dbuser', 'pitchar_project');
define('dbpass', '111444777aaa@@@');
define('dbname', 'pitchar_project');
define('site_url', $_SERVER['SERVER_NAME']);
define('site_name', 'PITCHAR.IO' );
define('site_email','support@pitchar.io');
...
*/
	...
	function sentEmail($subject,$toname,$toemail,$html){
		$from = new SendGrid\Email(site_name,admin_email);
		$subject = $subject;
